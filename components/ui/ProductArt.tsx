 ...
 * under /public/images/products/<slug>.{jpg,jpeg,png,webp}. Otherwise
 * renders a stylized SVG bottle tinted with the product's hero color.
 *
 * Image manifest is keyed by product slug, generated by
 * scripts/sync-wp-products.mjs from the live WP catalog.
 */
export function ProductArt({
  ...
  const imgSrc = getProductImage(productSlug);
